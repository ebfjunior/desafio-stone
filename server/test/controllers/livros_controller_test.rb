...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { descricao: @livro.descricao, nome: @livro.nome, valor: @livro.valor } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { descricao: @livro.descricao, nome: @livro.nome, valor: @livro.valor } }
